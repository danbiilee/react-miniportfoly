    ...
    <Post>
      ...
      <Wrapper>
        ...
        <div className="wrapper">
          <h4>:: 가장 기억 남는 여행</h4>
          <p>
            이상하게 요즘 말레이시아에서 버스 타고 이동하던 때의 기억이 자주
            떠오른다
          </p>
        </div>
        <div className="wrapper">
        ...
        <div className="wrapper">
          <h4>:: 가장 좋아하는 노래</h4>
          <p>
            최근에 가장 꽂혀있던 노래는 애쉬 아일랜드의 악몽, 웨이체드의 Why do
            you say
          </p>
        </div>
        <div className="wrapper">
          <h4>:: 좋아하는 가수</h4>
          <p>
            요즘 꽂혀있는 가수는 애쉬 아일랜드, 스키니 브라운, 쿠기, 식케이, 문
          </p>
        </div>
        <div className="wrapper">
          <h4>:: 내가 가장 열렬하게 덕질했던 대상은?</h4>
          <p>
            진짜 너무 많은데 가장 대표적인 3명만 꼽으면 권지용, 박재범, 변백현
          </p>
        </div>
        <div className="wrapper">
          <h4>:: 가장 최근에 읽은 책은?</h4>
